describe('transport', function () {
    ...
    it ('should validate method call success and error callback types', function () {

    });

    it('should add and remove non-transient API calls to the pending calls stack', function () {
